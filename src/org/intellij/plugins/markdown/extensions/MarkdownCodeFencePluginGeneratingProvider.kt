...
interface MarkdownCodeFencePluginGeneratingProvider {
  ...
  companion object {
    val EP_NAME: ExtensionPointName<MarkdownCodeFencePluginGeneratingProvider> = ExtensionPointName.create<MarkdownCodeFencePluginGeneratingProvider>("org.intellij.zenuml.codeFencePluginGeneratingProvider")
  }
}